...
export function Header({ route }) {
  ...
  return (
    <header className="m-0">
      <nav className="relative flex min-h-[70px] items-center justify-between gap-2 border-b-[3px] border-[#9b6a2b] bg-[#4b120f] px-3 py-2 text-center shadow-md md:gap-5 md:px-10" aria-label="Main navigation">
        <a className="flex min-w-0 items-center gap-2 text-left text-[16px] uppercase leading-[.9] tracking-[.6px] text-[#f5d7a0] no-underline md:gap-3 md:text-[22px] md:tracking-[1px]" href="#/home">
          <span className="text-[26px] leading-none text-[#d39a2e] md:text-[38px]">&#10019;</span>
          <span className="min-w-0">Ronald Lex<br />Stout</span>
        </a>
        ...
        <div className="flex items-center gap-2">
          <a className="hidden whitespace-nowrap border border-[#f0c76a] bg-gradient-to-b from-[#d9ad4e] to-[#a97724] px-3 py-2 text-[12px] font-bold uppercase tracking-[.7px] text-[#3a160f] no-underline sm:inline-block md:px-6 md:text-[13px]" href="#/contact">Contact Ronny</a>
          <button
